...
- [PBKDF2](https://en.wikipedia.org/wiki/PBKDF2) is the default recommendation by NIST and has validated FIPS-140 compliance. However, bcrypt is preferred as it holds up better with GPU/ASIC attacks than PBKDF2 with similar inputs.
