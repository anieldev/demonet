...
- [PBKDF2](https://en.wikipedia.org/wiki/PBKDF2) is the default recommendation by NIST and has validated FIPS-140 compliance. However, bcrypt is preferred over PBKDF2 as it holds up better with GPU/ASIC attacks under similar conditions.
